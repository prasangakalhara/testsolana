...
const useRefresh = ({ stage, gatekeeperClient, networkConfig, }, state, dispatch) => {
    ...
    const waitForUnexpiredGatewayToken = (0, react_1.useCallback)(() => {
        let isExpired = (gatewayToken === null || gatewayToken === void 0 ? void 0 : gatewayToken.expiryTime) && (0, tokenUtils_1.hasExpired)(gatewayToken.expiryTime);
        logDebug('waitForUnexpiredGatewayToken pre-promise isExpired', isExpired);
        if (!isExpired)
            return Promise.resolve();
        logDebug('waitForUnexpiredGatewayToken isExpired, creating promise');
        return new Promise((resolve, reject) => {
            isExpired = (gatewayToken === null || gatewayToken === void 0 ? void 0 : gatewayToken.expiryTime) && (0, tokenUtils_1.hasExpired)(gatewayToken.expiryTime);
    ...
    }, [gatewayToken === null || gatewayToken === void 0 ? void 0 : gatewayToken.expiryTime, setTimeoutForRefresh, gatekeeperNetworkAddress]);
    return {
